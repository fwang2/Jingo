...
extension Font {
  enum DS {
    static var action: Font {
      JingoKitFontFamily.Poppins.medium.swiftUIFont(size: UIFont.preferredFont(forTextStyle: .body).pointSize)
    }

    static var actionSecondary: Font {
      JingoKitFontFamily.Poppins.regular.swiftUIFont(size: UIFont.preferredFont(forTextStyle: .body).pointSize)
    }

    static var body: Font {
      JingoKitFontFamily.Karla.regular.swiftUIFont(size: UIFont.preferredFont(forTextStyle: .body).pointSize)
    }

    static var bodyBold: Font {
      JingoKitFontFamily.Karla.bold.swiftUIFont(size: UIFont.preferredFont(forTextStyle: .body).pointSize)
    }

    static var caption: Font {
      JingoKitFontFamily.Poppins.regular.swiftUIFont(size: UIFont.preferredFont(forTextStyle: .caption1).pointSize)
    }

    static var captionBold: Font {
      JingoKitFontFamily.Poppins.medium.swiftUIFont(size: UIFont.preferredFont(forTextStyle: .caption1).pointSize)
    }

    static var footnote: Font {
      JingoKitFontFamily.Poppins.regular.swiftUIFont(size: UIFont.preferredFont(forTextStyle: .footnote).pointSize)
    }

    static var badge: Font {
      JingoKitFontFamily.Poppins.semiBold.swiftUIFont(size: UIFont.preferredFont(forTextStyle: .caption2).pointSize)
    }

    static var title: Font {
      JingoKitFontFamily.Poppins.regular.swiftUIFont(size: UIFont.preferredFont(forTextStyle: .title1).pointSize)
    }

    static var titleSmall: Font {
      JingoKitFontFamily.Poppins.regular.swiftUIFont(size: UIFont.preferredFont(forTextStyle: .title2).pointSize)
    }

    static var titleBold: Font {
      JingoKitFontFamily.Poppins.medium.swiftUIFont(size: UIFont.preferredFont(forTextStyle: .title1).pointSize)
    }
  }
}
...
extension TextStyle {
  ...
  static let subheadline = TextStyle(font: Font.DS.body, lineSpacing: 3, foregroundColor: Color.DS.Text.base, kerning: 0)
}
