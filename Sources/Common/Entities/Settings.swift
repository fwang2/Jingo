...
public struct Settings: Hashable {
  ...
  public init(
    ...
    selectedModelName: String = Model.defaultModelName,
...
extension Settings: Codable {
  ...
  public init(from decoder: Decoder) throws {
    ...
    selectedModelName = (try? container.decode(String.self, forKey: .selectedModelName)) ?? Model.defaultModelName
    ...
    isLiveTranscriptionEnabled = (try? container.decode(Bool.self, forKey: .isLiveTranscriptionEnabled)) ?? true
  }
}
