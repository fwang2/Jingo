...
public struct RecordingInfo: Identifiable, Hashable, Then {
  ...
  public var isTranscribed: Bool {
    transcription?.status.isDone == true && !text.trimmingCharacters(in: .whitespacesAndNewlines).isEmpty
  }
...
extension RecordingInfo: Codable {
  enum CodingKeys: String, CodingKey {
    case fileName, title, date, duration, editedText, transcription, speakerNames, summary
